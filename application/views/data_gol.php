...
<body>
	...
	$template = array(
		...
		$this->table->set_heading('No' , 'Nama Tim' , 'Jenis Liga' , 'Negara' , 'Update', 'Hapus');		
	$no = 1;
	foreach ($data_gol as $sf) :
		$this->table->add_row($no++, $sf->nama_tim, $sf->jenis_liga, $sf->negara, anchor('Gol/ambil_data_gol/'.
		$sf->id,'Edit'), anchor('Gol/hapus/'.$sf->id,'Hapus'));
	endforeach;
